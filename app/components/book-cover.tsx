...
export const BookCover = ({ book }: any) => {
  return (
    <div className="relative flex bg-si-brown text-nuetral-900 w-40 h-56 md:w-44 md:h-60 rounded-lg hover:cursor-pointer hover:scale-110 transition-transform duration-200">
      ...
      <div className="flex flex-col justify-between w-full border-si-dark border-2 m-2 rounded-lg">
        ...
        <span className="pl-2 pb-2 font-serif">
          {book.contributor.fullName}
        </span>
      </div>
    </div>
  );
